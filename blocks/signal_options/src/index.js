  ...
  render: function () {
    ...
    return (
      ...
      >
        ...
        <ToggleControl
          label    = {__("Include the url in the message even if the whole content is posted","tsjippy",)}
          checked  = {signalUrl}
